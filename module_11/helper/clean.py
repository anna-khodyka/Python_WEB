...
class CleanFolder:
    ...
    def normalize_file_name(self, file_name):
        ...
        for part in file_name.split("."):
            ...
            if counter == len(file_name.split(".")):
                ...
                normalized_file_name = normalized_file_name + self.normalize(part) + "."
            else:
                normalized_file_name = normalized_file_name + self.normalize(part) + "_"
    ...
    def parse_folder(self, folder_path):
        ...
        if folder_path.exists() and (folder_path.is_dir() == False):
            raise ValueError(f"Указанный путь {folder_path.absolute()} - не папка")
