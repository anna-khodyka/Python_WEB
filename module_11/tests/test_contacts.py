...
def test_add(client, app):
    ...
    response = client.post(
        '/add', data={'name': 'Anya', 'birthday': '12.03.1980', 'address': 'Bucha', "email": "anna@bigmir.net", "tags": "friends", "phone": "+380978440011"}, follow_redirects=True
    )
...
def test_add_with_bad_birthday(client, app):
    response = client.post(
        '/add', data={'name': 'Vasya', 'birthday': '99.03.1980', 'address': 'Bucha', "email": "anna@bigmir.net", "tags": "friends", "phone": "+380978440011"}, follow_redirects=True
    )
    assert response.status_code == 200
...
def test_add_with_bad_address(client, app):
    response = client.post(
        '/add', data={'name': 'Kolya', 'birthday': '01.03.1980', 'address': 'BuchaBuchaBuchaBuchaBuchaBuchaBuchaBuchaBuchaBuchaBuchaBuchaBuchaBuchaBuchaBucha', "email": "anna@bigmir.net", "tags": "friends", "phone": "+380978440011"}, follow_redirects=True
    )
    print(response.data)
    assert response.status_code == 200
...
def test_add_with_empty_name(client, app):
    response = client.post(
        '/add', data={'name': '', 'birthday': '01.03.1980', 'address': 'Bucha', "email": "anna@bigmir.net", "tags": "friends", "phone": "+380978440011"}, follow_redirects=True
    )
    assert response.status_code == 200
...
def test_add_with_bad_tags(client, app):
    response = client.post(
        '/add', data={'name': 'Vasya', 'birthday': '01.03.1980', 'address': 'Bucha', "email": "anna.bigmir.net", "tags": "friendsfriendsfriendsfriendsfriendsfriendsfriendsfriends", "phone": "+380978440011"}, follow_redirects=True
    )
    assert response.status_code == 200
...
def test_add_with_bad_phone(client, app):
    response = client.post(
        '/add', data={'name': 'Vasya', 'birthday': '01.03.1980', 'address': 'Bucha', "email": "anna.bigmir.net", "tags": "friends", "phone": "38097844001155"}, follow_redirects=True
    )
    assert response.status_code == 200
...
def test_delete(client, app):
    ...
    response = client.post(
        "/12/delete", follow_redirects=True)
    assert response.status_code == 200
...
def test_edit(client, app):
    ...
    response = client.post(
        '/1/edit', data={'name': 'upd name', 'birthday': '1980-06-12',
                         'address': 'test address', 'email': 'test@test.ts', 'tags': 'test tag', 'phone': '+380661112233'}, follow_redirects=True
    )
...
def test_edit_with_empty_name(client, app):
    response = client.post(
        '/1/edit', data={'name': '', 'birthday': '12.06.1980',
                         'address': 'test address', 'email': 'test@test.ts', 'tags': 'test tag', 'phone': '+380661112233'}, follow_redirects=True
    )
    assert response.status_code == 200
    assert b"Name is required." in response.data
...
def test_edit_with_bad_birthday(client, app):
    response = client.post(
        '/1/edit', data={'name': 'upd name', 'birthday': '99.06.1980',
                         'address': 'test address', 'email': 'test@test.ts', 'tags': 'test tag', 'phone': '+380661112233'}, follow_redirects=True
    )
    assert response.status_code == 200
    assert b"Wrong Birthday." in response.data
...
def test_edit_with_bad_address(client, app):
    response = client.post(
        '/1/edit', data={'name': 'upd name', 'birthday': '12.06.1980',
                         'address': 'test address test address test address test address test address test address', 'email': 'test@test.ts', 'tags': 'test tag', 'phone': '+380661112233'}, follow_redirects=True
    )
    assert response.status_code == 200
    assert b"Please no more than 30 symbols" in response.data
...
def test_edit_with_bad_tags(client, app):
    response = client.post(
        '/1/edit', data={'name': 'upd name', 'birthday': '12.06.1980',
                         'address': 'test address', 'email': 'test@test.ts', 'tags': 'test tag test tag test tag test tag test tag', 'phone': '+380661112233'}, follow_redirects=True
    )
    assert response.status_code == 200
    assert b"Please no more than 15 symbols" in response.data
...
def test_edit_with_bad_phone(client, app):
    response = client.post(
        '/1/edit', data={'name': 'upd name', 'birthday': '12.06.1980',
                         'address': 'test address', 'email': 'test@test.ts', 'tags': 'test tag', 'phone': '+38'}, follow_redirects=True
    )
    assert response.status_code == 200
    assert b"Phone may start with + and has from 3 to 12 digits max" in response.data
